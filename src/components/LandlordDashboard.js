...
import './LandlordDashboard.css'; // Import custom CSS file
import Navbar3 from './Navbar3'; // Import the Navbar component
import { Button, Card, Table, Container } from 'react-bootstrap';
import ImageModal from './ImageModal'; // Assuming you have an ImageModal component
...
const LandlordDashboard = () => {
  ...
  return (
    <Container className="landlord-dashboard">
      <h1 className="text-center my-4">Landlord Dashboard</h1>
          ...
          <div className="d-flex flex-wrap justify-content-between mb-4">
            <Card className="analytics-card">
              <Card.Body>
                ...
                <Card.Text>{analytics.total_rooms}</Card.Text>
              </Card.Body>
            </Card>
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Available Rooms</Card.Title>
                <Card.Text>{analytics.available_rooms}</Card.Text>
              </Card.Body>
            </Card>
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Unavailable Rooms</Card.Title>
                <Card.Text>{analytics.unavailable_rooms}</Card.Text>
              </Card.Body>
            </Card>
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Reserved Rooms</Card.Title>
                <Card.Text>{analytics.reserved_rooms}</Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div className="d-flex flex-wrap justify-content-between mb-4">
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Confirmed Payments</Card.Title>
                <Card.Text>{analytics.confirmed_payments}</Card.Text>
              </Card.Body>
            </Card>
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Pending Payments</Card.Title>
                <Card.Text>{analytics.pending_payments}</Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div className="d-flex flex-wrap justify-content-between mb-4">
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Completed Requests</Card.Title>
                <Card.Text>{analytics.completed_requests}</Card.Text>
              </Card.Body>
            </Card>
            <Card className="analytics-card">
              <Card.Body>
                <Card.Title>Pending Requests</Card.Title>
                <Card.Text>{analytics.pending_requests}</Card.Text>
              </Card.Body>
            </Card>
          </div>
        </div>
      ...
      {activeSection === 'roomStatus' && (
        <div>
          <h2>Room Status</h2>
          <Table striped bordered hover className="room-status-table">
            <thead>
              <tr>
                <th>Room Name</th>
                <th>Room Number</th>
      ...
      {activeSection === 'pendingPayments' && (
        <div>
          <h2>Payments</h2>
          <Table striped bordered hover className="pending-payments-table">
            <thead>
              <tr>
                <th>Username</th>
                <th>Email</th>
                    ...
                    <td>
                      {payment.payment_proof ? (
                        <img 
                          ...
                          onClick={() => handleImageClick(payment.payment_proof)} 
                        />
                      ) : (
